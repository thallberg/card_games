...
/**
 * Skapar en standardkortlek på 52 kort (utan jokrar).
 */
...
/**
 * Filnamn för ett kort (matchar SVG i public/playing-cards/svg-cards).
 * T.ex. { suit: "hearts", rank: "2" } -> "2_of_hearts.svg"
 */
